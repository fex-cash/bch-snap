import { binStringToBin, hexToBin, utf8ToBin } from '../format/format';
import type {
...
import { bigIntToVmNumber } from '../vm/vm';

import type { CompilationResult } from './language-types';
import {
  IdentifierResolutionErrorType,
  IdentifierResolutionType,
} from './language-types';
import { getResolutionErrors, stringifyErrors } from './language-utils';
