 ...
 */
import { encodeBech32, regroupBits } from '../address/address';
import { createCompilerBCH } from '../compiler/compiler-bch/compiler-bch';
import { authenticationTemplateToCompilerConfiguration } from '../compiler/compiler-utils';
...
import { slot1Scenario } from './bch-vmb-test-mixins';
