...
Command: yarn wallet generate <hd_private_key> <transaction_hex>
   E.g.: yarn wallet generate out/transactionson xprv9s21ZrQH143K2JbpEjGU94NcdKSASB7LuXvJCTsxuENcGN1nVG7QjMnBZ6zZNcJaiJogsRaLaYFFjs48qt4Fg7y1GnmrchQt1zFNu6QVnta 020000...
...
const outputAbsolutePath = `${resolve('temp')}/vmb_tests_liveon`;
