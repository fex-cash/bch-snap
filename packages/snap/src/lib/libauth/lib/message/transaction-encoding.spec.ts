...
import tokenPrefixInvalidJson from './fixtures/token-prefix-invalidon' assert { type: 'json' };
// eslint-disable-next-line import/no-restricted-paths, import/no-internal-modules
import tokenPrefixValidJson from './fixtures/token-prefix-validon' assert { type: 'json' };
...
test('CashTokens: token-prefix-validon', (t) => {
...
test('CashTokens: token-prefix-invalidon', (t) => {
