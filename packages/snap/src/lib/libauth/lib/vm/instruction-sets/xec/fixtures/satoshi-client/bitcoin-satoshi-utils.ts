...
import { OpcodesXEC } from '../../xec-opcodes';
...
/**
 * Convert a string from the Satoshi implementation's `script_testson`
 ...
 * push a number to the stack. In the `script_testson` text-format, numbers
