import { int32UnsignedToSigned } from '../../../format/format';
import type {
...
import type { AuthenticationProgramStateCodeSeparator } from '../../vm-types';
...
import { encodeAuthenticationInstructions } from './instruction-sets-utils';
