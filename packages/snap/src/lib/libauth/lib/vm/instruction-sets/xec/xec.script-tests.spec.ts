...
import scriptTestsAddendum from './fixtures/satoshi-client/script-tests-addendumon' assert { type: 'json' };
// eslint-disable-next-line import/no-restricted-paths, import/no-internal-modules
import scriptTests from './fixtures/satoshi-client/script_testson' assert { type: 'json' };
